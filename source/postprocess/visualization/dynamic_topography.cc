  ...
  namespace Postprocess
  {
    namespace VisualizationPostprocessors
    {
      ...
      DynamicTopography<dim>::execute() const
      {
        ...
        // Get a pointer to the dynamic topograhy postprocessor.
        ...
        // Use trapezoidal quadrature to get an average topopgraphy per cell.
            ...
            if (cell->at_boundary())
              {
                ...
                // Topography values are stored in the temperature component of the
                // BlockVector.
      ...
      /**
       * Get a list of the postprocessors that this one depends on
       * (that is, the DynamicTopography postprocessor).
       */
      template <int dim>
      std::list<std::string>
